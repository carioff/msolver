...
// function addDataObj(jQuery, dataObj, keyNm, keyVal){
// 	let tmpObj = {keyNm, keyVal}; 
// 	$.extend(dataObj, tmpObj);
// }
// function addDataObj(jQuery, dataObj, keyNm, keyVal) {
//     let tmpObj = {keyNm, keyVal}; 
// 	angular.copy(dataObj, tmpObj);
// }
/**
 * <ul>
 * <li>2014.04.24</li>
...
// function addDataMapObj(dataObj, keyVal) {
// 	$.extend(dataObj,keyVal);
// }
// (function addDataObj(jQuery,dataObj, keyVal) {
// 	$.extend(dataObj, keyVal);
// }());
/**
 * <ul>
...
var commonHttpPostSender = function($http, ctrUrl, dataObj, afterSuccessFunc, afterErrorFunc) {
	...
	// 			alert('요청을 처리할 수 없습니다.')
	// 		} else {
	// 			alert('요청을 처리할 수 없습니다 :' + returnData);
	// 		}
	// 	}
	// );
};
...
function logOutFunc($http) {
	...
	var logout_url = getContextPath() + '/logout';
...
/*
 * 2014.09.11  function name : getMaxTextByWidth function description : 최대 표시
 ...
 * <li>2017.02.13</li>
 * <li>ckim</li>
 * <li>function name: chkBrowerName</li>
 * <li>function description: 사용중인 브라우저이름 체크</li>
 * </ul>
 * @param str
 * @returns str
 */
function chkBrowerName(){
