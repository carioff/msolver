...
public abstract class MybatisCustom {

	protected Logger log = LoggerFactory.getLogger(MybatisCustom.class);
	...
	public MybatisCustom() {
		super();
		this.nameSpace = "";
	}

	public MybatisCustom(String nameSpace) {
		super();
